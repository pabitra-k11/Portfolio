      ...
      <div className="home d-flex justify-content-around row-cols-md row-cols-sm ">
        <div className="left row-cols-md">
          ...
          <div className="type1">
            ...
            <a href="https://drive.google.com/file/d/10FIg9vWx0x4f4OQvfeAHuchRiXDbwFEi/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="btns">Download Resume</button></a>
